...
enum DWARF_ASCEND_REGNUM {
  ...
  dwarf_p7_ascend,
  // ULD0-ULD7
  dwarf_uld0_ascend = 257,
  dwarf_uld1_ascend,
  dwarf_uld2_ascend,
  dwarf_uld3_ascend,
  // UST0-UST7
  dwarf_ust0_ascend = 261,
  dwarf_ust1_ascend,
  dwarf_ust2_ascend,
  dwarf_ust3_ascend,
  // simt r0-r126
  ...
  dwarf_tpesl8_ascend,
  dwarf_tpesl9_ascend,
  dwarf_tpesl10_ascend,
  dwarf_tpesl11_ascend,
  dwarf_tpesl12_ascend,
  dwarf_tpesl13_ascend,
  dwarf_tpesl14_ascend,
  dwarf_tpesl15_ascend,

  dwarf_tpesll0_ascend = 505,
  dwarf_tpesll1_ascend,
  dwarf_tpesll2_ascend,
  dwarf_tpesll3_ascend,
  dwarf_tpesll4_ascend,
  dwarf_tpesll5_ascend,
  dwarf_tpesll6_ascend,
...
struct ErrInfoReg {
  ...
  std::vector<std::pair<uint64_t, uint64_t>> pc_mask_map;
};
...
public:
  ...
  virtual Status GetRegisterAddr(const llvm::StringRef reg_name,
                                 CoreType core_type, InterruptPosType pos_type,
                                 uint64_t &addr) = 0;
