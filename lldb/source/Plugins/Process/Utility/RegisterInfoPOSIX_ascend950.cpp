...
enum LLDB_ASCEND_RENUM {
  ...
  lldb_ust_flag_3_ascend, lldb_s0_ascend, lldb_s1_ascend, lldb_s2_ascend,
  lldb_s3_ascend, lldb_s4_ascend, lldb_s5_ascend, lldb_s6_ascend,
  lldb_s7_ascend, lldb_s8_ascend, lldb_s9_ascend, lldb_s10_ascend,
  lldb_s11_ascend, lldb_s12_ascend, lldb_s13_ascend, lldb_s14_ascend,
  lldb_s15_ascend, lldb_s16_ascend, lldb_s17_ascend, lldb_s18_ascend,
  lldb_s19_ascend, lldb_s20_ascend, lldb_sreg_21_ascend, lldb_sreg_22_ascend,
  ...
  lldb_simt_pc_ascend, lldb_su_pc_ascend, lldb_mrf_ascend, lldb_p_register_ascend, lldb_execmask_ascend,
  ...
  k_last_vecrb_reg_ascend = lldb_r19_ascend,
...
static const DeviceRegisterInfo REGISTER_950_INFO[] = {
  ...
  {ASCEND_GPR_4B(SREG_0, s0), VEC_ID << ID_OFFSET | 2UL << 48 | 2560, AIV_MASK},
  {ASCEND_GPR_4B(SREG_1, s1), VEC_ID << ID_OFFSET | 2UL << 48 | 2561, AIV_MASK},
  {ASCEND_GPR_4B(SREG_2, s2), VEC_ID << ID_OFFSET | 2UL << 48 | 2562, AIV_MASK},
  {ASCEND_GPR_4B(SREG_3, s3), VEC_ID << ID_OFFSET | 2UL << 48 | 2563, AIV_MASK},
  {ASCEND_GPR_4B(SREG_4, s4), VEC_ID << ID_OFFSET | 2UL << 48 | 2564, AIV_MASK},
  {ASCEND_GPR_4B(SREG_5, s5), VEC_ID << ID_OFFSET | 2UL << 48 | 2565, AIV_MASK},
  {ASCEND_GPR_4B(SREG_6, s6), VEC_ID << ID_OFFSET | 2UL << 48 | 2566, AIV_MASK},
  {ASCEND_GPR_4B(SREG_7, s7), VEC_ID << ID_OFFSET | 2UL << 48 | 2567, AIV_MASK},
  {ASCEND_GPR_4B(SREG_8, s8), VEC_ID << ID_OFFSET | 2UL << 48 | 2568, AIV_MASK},
  {ASCEND_GPR_4B(SREG_9, s9), VEC_ID << ID_OFFSET | 2UL << 48 | 2569, AIV_MASK},
  {ASCEND_GPR_4B(SREG_10, s10), VEC_ID << ID_OFFSET | 2UL << 48 | 2570, AIV_MASK},
  {ASCEND_GPR_4B(SREG_11, s11), VEC_ID << ID_OFFSET | 2UL << 48 | 2571, AIV_MASK},
  {ASCEND_GPR_4B(SREG_12, s12), VEC_ID << ID_OFFSET | 2UL << 48 | 2572, AIV_MASK},
  {ASCEND_GPR_4B(SREG_13, s13), VEC_ID << ID_OFFSET | 2UL << 48 | 2573, AIV_MASK},
  {ASCEND_GPR_4B(SREG_14, s14), VEC_ID << ID_OFFSET | 2UL << 48 | 2574, AIV_MASK},
  {ASCEND_GPR_4B(SREG_15, s15), VEC_ID << ID_OFFSET | 2UL << 48 | 2575, AIV_MASK},
  {ASCEND_GPR_4B(SREG_16, s16), VEC_ID << ID_OFFSET | 2UL << 48 | 2576, AIV_MASK},
  {ASCEND_GPR_4B(SREG_17, s17), VEC_ID << ID_OFFSET | 2UL << 48 | 2577, AIV_MASK},
  {ASCEND_GPR_4B(SREG_18, s18), VEC_ID << ID_OFFSET | 2UL << 48 | 2578, AIV_MASK},
  {ASCEND_GPR_4B(SREG_19, s19), VEC_ID << ID_OFFSET | 2UL << 48 | 2579, AIV_MASK},
  {ASCEND_GPR_4B(SREG_20, s20), VEC_ID << ID_OFFSET | 2UL << 48 | 2580, AIV_MASK},
  ...
  {ASCEND_GPR_4B(R0, r0), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R1, r1), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R2, r2), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R3, r3), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R4, r4), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R5, r5), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R6, r6), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R7, r7), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R8, r8), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R9, r9), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R10, r10), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R11, r11), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R12, r12), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R13, r13), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R14, r14), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R15, r15), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R16, r16), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R17, r17), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R18, r18), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  {ASCEND_GPR_4B(R19, r19), VEC_ID << ID_OFFSET | 9UL << 48 | 81920, AIV_MASK},
  // TODO: Add RX 
