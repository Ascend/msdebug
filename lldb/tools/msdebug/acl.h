...
VISIBILITY_EXPORT aclError aclrtGetFuncBySymbolImpl(const void *symbol, aclrtFuncHandle *funcHandle);
VISIBILITY_EXPORT int32_t rtRegisterFuncSymbol(void *binHandle, const void *symbol, const char *kernelName, void *reserve);
