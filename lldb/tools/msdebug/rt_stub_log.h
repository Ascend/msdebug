...
enum MSDEBUG_ERROR_CODE {
  ...
  RT_KERNEL_LAUNCH_WITH_FLAG_V2_NOT_FOUND_ERR =
      0x10108, // rtKernelLaunchWithFlagV2
  RT_KERNEL_LAUNCH_WITH_HANDLE_V2_NOT_FOUND_ERR =
      0x10109, // rtKernelLaunchWithHandleV2
  RT_KERNEL_GET_ADDR_AND_PREF_CNT_NOT_FOUND_ERR =
      0x1010A,                                // rtKernelGetAddrAndPrefCnt
  ...
  RT_GET_TASK_ID_AND_STREAM_ID_NOT_FOUND_ERR =
      0x1010E, // rtGetTaskIdAndStreamID
  RT_STREAM_SYNC_WITH_TIMEOUT_NOT_FOUND_ERR =
      0x1010F, // rtStreamSynchronizeWithTimeoutFunc
  RT_GET_VISIBLE_DEVID_BY_LOGIC_DEVID_NOT_FOUND_ERR =
      0x10110,                            // rtGetVisibleDeviceIdByLogicDeviceId
  ...
  RT_REGISTER_FUNC_SYMBOL_NOT_FOUND_ERR = 0x10114,  //
  ...
  ACLRT_BINARY_GET_FUNCTION_IMPL_NOT_FOUND_ERR =
      0x10124, // aclrtBinaryGetFunctionImpl
  ACLRT_BINARY_GET_FUNCTION_BY_ENTRY_IMPL_NOT_FOUND_ERR =
      0x10125, // aclrtBinaryGetFunctionByEntryImpl
  ACLRT_LAUNCH_KERNEL_IMPL_NOT_FOUND_ERR = 0x10126, // aclrtLaunchKernelImpl
  ACLRT_LAUNCH_KERNEL_WITH_CONFIG_IMPL_NOT_FOUND_ERR =
      0x10127, // aclrtLaunchKernelWithConfigImpl
  ACLRT_GET_FUNCTION_ADDR_IMPL_NOT_FOUND_ERR =
      0x10128,                                     // aclrtGetFunctionAddrImpl
  ACLRT_GET_SOC_NAME_IMPL_NOT_FOUND_ERR = 0x10129, // aclrtGetSocNameImpl
  ACLRT_BINARY_LOAD_FROM_FILE_IMPL_NOT_FOUND_ERR =
      0x1012A, // aclrtBinaryLoadFromFileImpl
  ...
  ACLRT_SYNC_STREAM_WITH_TIMEOUT_IMPL_NOT_FOUND_ERR =
      0x1012E, // aclrtSynchronizeStreamWithTimeoutImpl
  ACLRT_LAUNCH_KERNEL_WITH_HOST_ARGS_IMPL_NOT_FOUND_ERR =
  ...
  ACLRT_MEM_GET_ADDRESS_RANGE_IMPL_NOT_FOUND_ERR =
      0x1013C,                            // aclrtMemGetAddressRangeImpl
  HAL_MEM_ADVISE_NOT_FOUND_ERR = 0x1013D, // halMemAdvise
  ACLRT_GET_LOGIC_DEVID_BY_USER_DEVID_IMPL_NOT_FOUND_ERR =
      0x1013E, // aclrtGetLogicDevIdByUserDevIdImpl
  ACLRT_GET_FUNC_BY_SYMBOL_IMPL_NOT_FOUND_ERR =
      0x1013F, // aclrtMemGetAddressRangeImpl
  ACLRT_SYNCHRONIZE_DEVICE_WITH_TIMEOUT_NOT_FOUND_ERR = 0x10140,
  // 其他错误
  ALLOC_ALREADY_OCCUPIED_DEVICE_ID_ERR = 0x10200, // 使用的device id已被占用
  RT_SET_DIFFERENT_DEVICE_ID_ERR =
      0x10201, // 检测到多次set device，且前后id不一致
  ACCESS_INVALID_RT_FUNC_NAME_ERR = 0x10202, // 尝试获取无效的rt函数指针
  GET_KERNEL_INFO_ERROR = 0x10203, // get kernel info failed, handle is not
                                   // saved when register function is running
  STUBFUNC_VECTOR_EMPTY_ERROR =
      0x10204, // stubFunc Vector is empty, can not get pc start
  ...
  RT_KERNEL_GET_ADDR_AND_PREF_CNT_FAILED_ERR =
      0x20002,                        // rtKernelGetAddrAndPrefCnt返回异常
  RT_GET_DEVICE_FAILED_ERR = 0x20003, // rtGetDeviceId返回异常
  RT_GET_SOC_VERSION_FAILED_ERR = 0x20004, // rtGetSocVersion返回异常
                                           //
  ACLRT_GET_FUNCTION_ADDR_IMPL_FAILED_ERR =
      0x20005, // aclrtGetFunctionAddrImpl 返回异常
  ...
  ACLRT_IPC_MEM_GET_EXPORT_KEY_FAILED_ERR =
      0x20009, // aclrtIpcMemGetExportKeyImpl返回异常
  ...
  ACLRT_FREE_WITH_DEV_SYNC_FAILED_ERR =
      0x20035, // aclrtFreeWithDevSyncImpl返回异常
